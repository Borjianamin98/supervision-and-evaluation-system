...
class ScheduleService {
    ...
    static announceFinalizationByUser(meetScheduleId: number) {
        return apiAxios
            .post<MeetSchedule>(`${ScheduleService.API_SCHEDULE_ROOT_PATH}/${meetScheduleId}/announceFinalization`)
            .then(response => response.data)
    }

    static requestRescheduleMeetSchedule(meetScheduleId: number) {
        return apiAxios
            .post<MeetSchedule>(`${ScheduleService.API_SCHEDULE_ROOT_PATH}/${meetScheduleId}/reschedule`)
            .then(response => response.data)
    }
